...
% Script only operates on subjects/tasks who have not been cleaned yet
...
origDestDir=[homeDir, '\Matlab\data\PreProcessedData\EMG\Sorted'];
% origDestDir = 'C:\Users\eran.shor\Desktop\EMG-PCP';
cleanedDestDir=[homeDir, '\Matlab\data\PreProcessedData\EMG\Cleaned'];
