...
datafileName = [getASBasePath(), '\Matlab\data\ASRawData.mat'];
...
save(dirToSave, 'ASRawData'); % in case of a big file use this addition to compress - , '-v7.3') ;
% saving the data structure to a file
